...
> - confirm previous results that Logistic Regression does better us using less than 10 hyperparameter search trials; for over 10 trials CNNs do better. Also LR has lower variance over all budgets.
